...
def number_of_tweets_per_day(df):
    """ The Function takes in a pandas dataframe as input.
        It then returns a new dataframe, grouped by day,
        with the number of tweets for that day. """
...
"""function to remove english stop words"""
    ...
    for row in df['Tweets']:
        ...
        tokenised_list.append(no_stops)   '# adds words not in stop word dictionary into tokenised_list'
